 ...
 *
 *A Java class to determine image width, height and MIME types for a number of image file formats 
 *without loading the whole image data.
 *
 *Revision history
...
/**
 * I copied this from http://blog.jaimon.co.uk/simpleimageinfo/SimpleImageInfo.java.html.
 *
 */
...
class SimpleImageInfo {
  ...
  SimpleImageInfo(File file) throws IOException {
